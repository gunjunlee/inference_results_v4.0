...
class Fields(Enum):
    ...
    coalesced_tensor: Field = Field(
        ...
        value_type=bool,
        supported_actions=_HARNESS_ACTIONS,
        supported_benchmarks=(Benchmark.BERT, Benchmark.GPTJ, Benchmark.LLAMA2, Benchmark.DLRMv2))
    ...
    use_fp8: Field = Field(
        ...
        supported_actions=_HARNESS_ACTIONS + (Action.GenerateEngines,),
        supported_systems=(SystemClassifications.gpu_based,),
        supported_benchmarks=(Benchmark.BERT, Benchmark.GPTJ, Benchmark.LLAMA2))
    ...
    use_int4awq: Field = Field(
        ...
        supported_actions=_HARNESS_ACTIONS + (Action.GenerateEngines,),
        supported_systems=(SystemClassifications.gpu_based,),
        supported_benchmarks=(Benchmark.GPTJ, Benchmark.LLAMA2))
    ...
    gpu_rank_map: Field = Field(
        ...
        supported_actions=_HARNESS_ACTIONS,
        supported_systems=(SystemClassifications.gpu_based,),
        supported_benchmarks=(Benchmark.LLAMA2,))
